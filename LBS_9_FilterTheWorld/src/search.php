 ...
 * 
 * @abstract	Create a Location Based Channel with filter options for the user (locally and based on server requests)
 * 				 				
 * 				Learnings:
 * 				- using more advanced HTML overlays
 * 				- adding and removing objects on the fly (using js)
 * 				- send additional request with parameters to your servers pois/search interface
 **/
